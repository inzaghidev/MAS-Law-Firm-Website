  ...
  return (
    <section className="py-24 relative overflow-hidden bg-[#0a0a0a]">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://images.unsplash.com/photo-1597920940566-a77511f9327d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=1080)",
        }}
      />

      {/* Dark Overlay */}
      <div className="absolute inset-0 bg-[#0F0F0F]/90 z-0 bg-gradient-to-b from-[#0F0F0F] via-[#0F0F0F]/95 to-[#0F0F0F]" />
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-serif text-[#AE8737]">Visi</h2>
              </div>
              <div className="w-16 h-[2px] bg-[#AE8737] mb-8" />

              <ul className="space-y-6">
                {visiItems.map((item, index) => (
                  <li key={index} className="flex gap-4">
                    <span className="mt-2 w-2 h-2 rounded-full bg-[#AE8737]" />
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-serif text-[#AE8737]">Misi</h2>
              </div>
              <div className="w-16 h-[2px] bg-[#AE8737] mb-8" />
