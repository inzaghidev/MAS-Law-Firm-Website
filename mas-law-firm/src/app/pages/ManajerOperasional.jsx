...
import managerImage from "../../assets/foto-pak-muhammad-dzulqarnain.jpg";
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto text-lg">
            Memastikan keunggulan operasional dan efisiensi layanan M.A.S Law
            Firm
          </p>
        </div>
              ...
              <div className="flex flex-col md:flex-row w-full p-8 md:p-12 items-center">
                ...
                <div className="w-full md:w-2/3 md:pl-12 text-white">
                  <div className="mb-8 text-center md:text-left">
                    ...
                    <p className="text-xl text-[#AE8737] font-serif tracking-wide">
